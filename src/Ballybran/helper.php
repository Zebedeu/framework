...
use Ballybran\Container\Container as Container;
...
if (!function_exists('app')) {
     ...
     *
     * @return mixed|\Ballybran\Kernel\Application
     * @throws
     */
...
if (!function_exists('config')) {
    ...
    {
        /** @var $config \Ballybran\Config\Config */
        $config = app('config');
        if (func_num_args() === 0) {
            return $config;
        }
...
if (!function_exists('abort')) {
    ...
    {
        if ($code === 404) {
            throw new \Ballybran\Exception\NotFoundHttpException($message);
        }

        throw new \Ballybran\Exception\HttpException($code, $message, null, $headers);
    }
}
...
if (!function_exists('admin')) {
     ...
     * @throws
     */
    function admin(): \Ballybran\Auth\Auth
    {
        return app()->makeWith(\Ballybran\Auth\Auth::class, ['prefix' => 'admin']);
    }
}
...
if (!function_exists('session')) {
    ...
    {
        /** @var \Ballybran\Http\Session $session */
        $session = app(\Ballybran\Http\Session::class);
        if (is_null($name)) {
            return $session;
        }
...
if (!function_exists('cookie')) {
    ...
    {
        /** @var \Ballybran\Http\Cookie $cookie */
        $cookie = app(\Ballybran\Http\Cookie::class);
        if (is_null($name)) {
            return $cookie;
        }
...
if (!function_exists('event')) {
    ...
    {
        return app(\Ballybran\Event\Event::class)->trigger($event, $params, $method);
    }
}
...
if (!function_exists('hasher')) {
     ...
     * @param array       $options
     *
     * @return string|\Ballybran\Hash\Hash
     * @throws
     */
...
if (!function_exists('bcrypt')) {
     ...
     * @param array       $options
     *
     * @return string|\Ballybran\Hash\BcryptHash
     */
...
if (!function_exists('request')) {
     ...
     * @param mixed        $default
     *
     * @return \Ballybran\Http\Request|string|array
     */
    function request($key = null, $default = null)
    {
        $request = app(\Ballybran\Http\Request::class);
        if (is_null($key)) {
            return $request;
        }
        if (is_array($key)) {
...
if (!function_exists('response')) {
    ...
    {
        if (func_num_args() === 0) {
            return app(\Ballybran\Http\Response::class);
        }

        return app()->make(\Ballybran\Http\Response::class, [
            'content' => $content,
            'status' => $status,
            'headers' => $headers,
        ]);
...
if (!function_exists('validation')) {
     ...
     *
     * @return \Ballybran\Http\Validation
     */
    function validation()
    {
        return app(\Ballybran\Http\Validation::class);
    }
}
...
if (!function_exists('trans')) {
     ...
     *
     * @return \Ballybran\Translation\Translator|string|array|null
     */
    function trans(?string $key = null, $replace = [], $locale = null)
    {
        /** @var \Ballybran\Translation\Translator $translator */
