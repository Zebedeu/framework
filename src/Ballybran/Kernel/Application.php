...
use Ballybran\Container\Container;
use Ballybran\Exception\ExceptionHandler;
...
class Application extends Container
{
    ...
    /**
     * The base path for the Knut7 Framework installation.
     *
     * @var string
     */
    protected $basePath;
    ...
    /**
     * Create a new Knut7 application instance.
     *
     * @return void
     */
    ...
    public function start(string $env): void
    {
        ...
        ini_set('error_log', $this->storagePath('log/knut7.log'));
    ...
    /**
     * Get the base path of the Knut7 Framework installation.
     *
    ...
    public function registerConfiguredProviders(): void
    {
        $providers = Collection::make($this->config['app.providers'])
            ->partition(function ($provider) {
                return Str::startsWith($provider, 'Knut7\\');
            });
    ...
    protected function init(): void
    {
        $this->registerCoreProviders = [
            \Ballybran\Providers\Event::class,
            \Ballybran\Providers\Request::class,
            \Ballybran\Providers\Response::class,
            \Ballybran\Providers\Session::class,
            \Ballybran\Providers\Cookie::class,
            \Ballybran\Providers\Route::class,
            \Ballybran\Providers\Uri::class,
            \Ballybran\Providers\Load::class,
            \Ballybran\Providers\Date::class,
            \Ballybran\Providers\Encryption::class,
            \Ballybran\Providers\Log::class,
        ];

        $this->registerCoreAliases = [
            'Request'   => \Ballybran\Facades\Request::class,
            'Response'  => \Ballybran\Facades\Response::class,
            'Cookie'    => \Ballybran\Facades\Cookie::class,
            'Session'   => \Ballybran\Facades\Session::class,
            'Route'     => \Ballybran\Facades\Route::class,
            'Uri'       => \Ballybran\Facades\Uri::class,
            'Date'      => \Ballybran\Facades\Date::class,
            'Log'       => \Ballybran\Facades\Log::class,
            'Validation'=> \Ballybran\Facades\Validation::class,
            'File'      => \Ballybran\Facades\File::class,
        ];
    }
    ...
    protected function registerBaseBindings(): void
    {
        ...
        $this->singleton('config', function () {
            return new \Ballybran\Config\Config($this->config);
        });
